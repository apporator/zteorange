...
local DDNSService_OBJNAME = "OBJ_DDNSSERVICE_ID"
local DDNSService_PARA =
{
"Server",
"ServerPort"
};
...
if string.find(_G.commConf.passCanSee,"Ddns") == nil then
t.Password = nil
end
...
tError = applyOrNewOrDelInst(DDNSService_OBJNAME, FP_ACTION, DDNSService_IDENTITY, transToPostTab(DDNSService_PARA))
end
